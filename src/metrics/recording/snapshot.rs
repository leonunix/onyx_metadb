...
impl MetaMetrics {
    pub fn snapshot(&self) -> MetaMetricsSnapshot {
        ...
        MetaMetricsSnapshot {
            ...
            flush_rc_delta_shadow_runs: load(&self.flush_rc_delta_shadow_runs),
            flush_rc_delta_shadow_records: load(&self.flush_rc_delta_shadow_records),
            flush_rc_delta_shadow_pages: load(&self.flush_rc_delta_shadow_pages),
            flush_rc_delta_shadow_payload_bytes: load(&self.flush_rc_delta_shadow_payload_bytes),
            flush_rc_delta_shadow_encode_us: load(&self.flush_rc_delta_shadow_encode_us),
            flush_rc_delta_shadow_encode_max_us: load(&self.flush_rc_delta_shadow_encode_max_us),
