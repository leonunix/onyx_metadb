...
impl MetaMetrics {
    pub fn snapshot(&self) -> MetaMetricsSnapshot {
        MetaMetricsSnapshot {
            ...
            apply_refcount_actions_sort_us: load(&self.apply_refcount_actions_sort_us),
            apply_refcount_actions_sort_sampled_actions: load(
                &self.apply_refcount_actions_sort_sampled_actions,
            ),
            apply_refcount_stage_sampled_us: load(&self.apply_refcount_stage_sampled_us),
            apply_refcount_pbas_materialize_us: load(&self.apply_refcount_pbas_materialize_us),
            ...
            apply_refcount_base_profiled_pbas: load(&self.apply_refcount_base_profiled_pbas),
            apply_refcount_base_page_runs: load(&self.apply_refcount_base_page_runs),
            apply_refcount_base_hole_runs: load(&self.apply_refcount_base_hole_runs),
            apply_refcount_base_overlay_runs: load(&self.apply_refcount_base_overlay_runs),
            apply_refcount_base_clean_runs: load(&self.apply_refcount_base_clean_runs),
            apply_refcount_base_output_init_us: load(&self.apply_refcount_base_output_init_us),
            apply_refcount_base_inner_lock_wait_us: load(
                &self.apply_refcount_base_inner_lock_wait_us,
            ),
            apply_refcount_base_page_resolve_us: load(&self.apply_refcount_base_page_resolve_us),
            apply_refcount_base_request_materialize_us: load(
                &self.apply_refcount_base_request_materialize_us,
            ),
            apply_refcount_base_cache_probe_us: load(&self.apply_refcount_base_cache_probe_us),
            apply_refcount_base_decode_us: load(&self.apply_refcount_base_decode_us),
            ...
            flush_rc_fold_validate_us: load(&self.flush_rc_fold_validate_us),
            flush_rc_fold_stage_us: load(&self.flush_rc_fold_stage_us),
            flush_rc_fold_remove_us: load(&self.flush_rc_fold_remove_us),
