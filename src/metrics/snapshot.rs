...
pub struct MetaMetricsSnapshot {
    ...
    pub apply_refcount_batch_count: u64,
    pub apply_refcount_batch_actions: u64,
    pub apply_refcount_batch_pbas: u64,
    ...
    pub apply_refcount_fold_lock_wait_max_us: u64,
    pub apply_refcount_slot_lock_wait_us: u64,
    pub apply_refcount_slot_lock_wait_max_us: u64,
    pub apply_refcount_pending_slot_scan_us: u64,
    pub apply_refcount_pending_slot_scan_max_us: u64,
    pub apply_refcount_delta_merge_us: u64,
    pub apply_refcount_delta_merge_max_us: u64,
    ...
    pub flush_rc_fold_lock_wait_us: u64,
    ...
    pub flush_rc_stream_max_chunk_us: u64,
    pub flush_rc_stream_max_chunk_pages: u64,
    pub flush_rc_delta_shadow_runs: u64,
    pub flush_rc_delta_shadow_records: u64,
    pub flush_rc_delta_shadow_pages: u64,
    pub flush_rc_delta_shadow_payload_bytes: u64,
    pub flush_rc_delta_shadow_encode_us: u64,
    pub flush_rc_delta_shadow_encode_max_us: u64,
    pub flush_rc_delta_shadow_verify_us: u64,
    pub flush_rc_delta_shadow_verify_max_us: u64,
    pub flush_rc_delta_shadow_errors: u64,
    pub flush_rc_segment_appends: u64,
    pub flush_rc_segment_pages: u64,
    ...
    pub flush_sample_rc_staged_pages: u64,
    pub flush_sample_rc_staged_pages_max: u64,
